...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "hero-mesh":
          "radial-gradient(at 27% 37%, hsla(215, 98%, 61%, 0.15) 0px, transparent 50%), radial-gradient(at 97% 21%, hsla(155, 98%, 35%, 0.12) 0px, transparent 50%), radial-gradient(at 52% 99%, hsla(215, 98%, 61%, 0.08) 0px, transparent 50%)",
        "card-shine":
